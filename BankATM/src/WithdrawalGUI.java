...
public class WithdrawalGUI extends JFrame{
	...
	public WithdrawalGUI(User user) {
		this.user = user;
        ...
        if(user.retrieveAccountByType("LoanAccount") != null)
        	accoutNumber--;
		...
		JLabel DepositLabel = new JLabel("Please choose an account to withdrawal then click the button");
		DepositLabel.setFont(new Font("Serif", Font.PLAIN, 50));
        JButton DepositButton = new JButton("Confirm");
        DepositButton.addActionListener(new WithdrawalListener());
		...
		class WithdrawalListener implements ActionListener {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				user.retrieveAccountByID(getAccountID).actionWithCharge("withdraw", money);
				
				JOptionPane.showMessageDialog(null, "Successfully withdrawal and 10 bucks fee taken!", "Info", JOptionPane.INFORMATION_MESSAGE);
